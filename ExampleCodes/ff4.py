...
#sudo mn --mac --custom ff4.py --topo mytopo --controller=remote,ip=127.0.0.1,port=6653 --switch=ovsk,protocols=OpenFlow13
...
#########################33
        self.addLink(s2d, s2e) 
        self.addLink(s2b, s2c) 
        self.addLink(s2a, s2g)
